...
<div class="container">
    <form method="POST" class="form-group" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <input type="text" name="modalidade" size="40" maxlength="50" class="form-control" required autofocus />
            </div>
        </div>
        <div class="row">
            <div class="col-sm-3 prompt">Descrição</div>
            <div class="col-sm-7">
                <textarea name="modal_descri" class="form-control" required ></textarea>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-3 prompt">Caracter ID</div>
            <div class="col-sm-1">
                <input type="text" name="modal_letraid" size="5" maxlength="1" class="form-control" required />
            </div>
        </div>
        <div class="row">
